...
public class SocketChannelReadHandle implements CompletionHandler<Integer, StringBuffer> {
    ...
    public void completed(Integer result, StringBuffer historyContext) {
        ...
        SocketChannelReadHandle.LOGGER.info("----2----completed(Integer result, Void attachment) : 然后我们来取出通道中准备好的值");
        /*
        ...
        try {
            ...
            SocketChannelReadHandle.LOGGER.info("--3-------目前的传输结果：" + historyContext);
