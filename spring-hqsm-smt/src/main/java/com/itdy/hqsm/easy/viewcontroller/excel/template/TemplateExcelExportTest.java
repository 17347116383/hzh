...
import com.itdy.hqsm.easy.entity.temp.BudgetAccountsEntity;
import com.itdy.hqsm.easy.entity.temp.PayeeEntity;
 ...
 */
@RestController
@RequestMapping("/mongo/TemplateExcelExportTest")
public class TemplateExcelExportTest {

    @RequestMapping("/1")
    public void test() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
                "exceltohtml/WEB-INF/doc/专项支出用款申请书.xls");
    ...
    public void fe_map() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
                "exceltohtml/WEB-INF/doc/专项支出用款申请书_map.xls");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("date", "2014-12-25");
        map.put("money", 2000000.00);
        map.put("upperMoney", "贰佰万");
