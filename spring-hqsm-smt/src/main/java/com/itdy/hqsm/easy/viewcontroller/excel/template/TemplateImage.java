 ...
 */
@RestController
@RequestMapping("/mongo/TemplateImage")
public class TemplateImage {
    ...
    public void img03() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
                "exceltohtml/doc/exportTemp_image.xls", true);
        ...
        for (int i = 1; i < 8; i++) {
            ...
            image.setHeight(400);
            image.setWidth(500);
            image.setUrl("/exceltohtml/imgs/company/baidu.png");
    ...
    public void img07Span() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
                "exceltohtml/doc/exportTemp_image.xlsx", true);
        Map<String, Object> map = new HashMap<String, Object>();
        // sheet 2
        map.put("month", 10);
        Map<String, Object> temp;
    ...
    public void listimg07() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
                "exceltohtml/doc/kyoffice_address_book_img.xls");
