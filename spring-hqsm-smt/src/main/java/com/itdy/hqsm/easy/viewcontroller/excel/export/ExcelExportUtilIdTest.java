 ...
 */
@Controller
@RequestMapping("/ExcelExportUtilIdTest")
public class ExcelExportUtilIdTest {

    static List<CourseEntity>  courseList   = new ArrayList<CourseEntity>();
    static List<TeacherEntity> telist = new ArrayList<TeacherEntity>();
    static List<StudentEntity> stuList=new ArrayList<StudentEntity>();
    static List<Map<String,Object>> schoolCourseList=new ArrayList<Map<String,Object>>();
    static CourseEntity        courseEntity;


    public  static void testBefor2() {
    ...
    public static void initStuData () throws Exception{
    	stuList.clear();
    ...
    public static void initCourseData() {
    ...
    public void templateExportDemo_1() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
            "exceltohtml/doc/kyoffice_address_book.xls",1,2);
