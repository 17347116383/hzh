...
public class RabbitmqConfig {
   ...
   // @Value("${spring.rabbitmq.publisher-confirms}")//开启发送确认
    private boolean publisherConfirms=true;

   //@Value("${spring.rabbitmq.publisher-returns}")//开启发送失败退回
    ...
    public ConnectionFactory connectionFactory() {
        ...
        //connectionFactory.setChannelCheckoutTimeout(25);
       // connectionFactory.setChannelCacheSize(56);
       // connectionFactory.setSimplePublisherConfirms();
       //如果连接已经激活，我们假设新侦听器希望得到通知
       // connectionFactory.setConnectionListeners();
        //connectionFactory.setCloseExceptionLogger();
